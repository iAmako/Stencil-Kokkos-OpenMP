...
void stencil(const int width, const int height, Kokkos::View<int ***, Kokkos::HostSpace> &src_image, Kokkos::View<int ***, Kokkos::HostSpace> &dst_image)
{
...
int main(int argc, char **argv)
{
    Kokkos::initialize(argc, argv);
    {
        ...
        Kokkos::View<int ***, Kokkos::HostSpace> src_image("src_image", height + 2, width + 2, 3);
        Kokkos::View<int ***, Kokkos::HostSpace> dst_image("dst_image", height + 2, width + 2, 3);
